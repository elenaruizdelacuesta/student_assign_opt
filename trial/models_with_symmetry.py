...
def step1_preference_maximal_assignment_symmetry(I, J, p, r_min, r_max):
    """
...
def solve_step2_equal_sized_symmetry(I, J, p, F_step1, a):
    """
...
def solve_step2_unequal_sized_symmetry(I, J, p, r_lb, r_up, F_step1, a):
    """
...
def solve_step3_equal_sized_symmetry(I, J, p, F_step1, Z_step2, a):
    """
...
def solve_step3_unequal_sized_symmetry(I, J, p, r_lb, r_ub, F_step1, Z_step2, a):
    """
